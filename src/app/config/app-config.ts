...
export class AppConfig {
  ...
  serveStatic: boolean;
  openstack_url: string;
  openstack_api_version: number;
  ...
  constructor(private environment: any) {
    ...
    this.openstack_url = this.getStringEnvVar('OPENSTACK_URL')
    this.openstack_api_version = this.getFloatEnvVar('OPENSTACK_API_VERSION')
    // optional environment variables
